...
export default function AdminSidebarLayout({
  ...
  return (
    <div className="flex bg-slate-50 min-h-screen pt-4"> {/* Slight padding to visually separate it if no global header */}
      {/* Sidebar */}
      <aside className="w-64 bg-slate-900 text-white min-h-screen flex flex-col fixed left-0 top-0 bottom-0 shadow-2xl z-50">
      ...
      {/* Main Content Area */}
      <main className="flex-1 ml-64 min-h-screen bg-slate-50 text-slate-900">
