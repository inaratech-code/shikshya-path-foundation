  ...
  return (
    <main>
      ...
      <section className="py-16 md:py-24 max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h2 className="text-center text-2xl sm:text-3xl font-black text-slate-900 mb-6">Our mission</h2>
        <p className="text-justify text-lg text-slate-600 leading-relaxed mb-10">
