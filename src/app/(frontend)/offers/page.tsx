  ...
  return (
    <main>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-center text-3xl font-bold mb-6 text-slate-900">Current Promotions</h2>
        <p className="text-justify max-w-2xl mx-auto text-lg text-slate-600 leading-relaxed mb-12">
